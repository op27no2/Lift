...
public class MyBigWidgetProviderX extends AppWidgetProvider {
	  ...
	  @Override
		public void onUpdate(Context context, AppWidgetManager appWidgetManager,
		  	...
		  	System.out.println("on updated called");
		
			ComponentName thisWidget = new ComponentName(context,
			        MyBigWidgetProviderX.class);
			    int[] allWidgetIds = appWidgetManager.getAppWidgetIds(thisWidget);
			    for (int widgetId : allWidgetIds) {

					System.out.println("set pending intents");
	  ...
	  public static PendingIntent buildButtonPendingIntent(Context context, int appWidgetId) {
		  System.out.println("set pending intent 1");

		  Intent intent = new Intent();
		    intent.setAction("pl.looksok.intent.action.bCHANGE_PICTUREX");
		...
		public static PendingIntent buildButtonPendingIntent2(Context context, int appWidgetId) {
		    ...
		    intent2.setAction("pl.looksok.intent.action.bCHANGE_PICTURE2X");
		...
		public static PendingIntent buildButtonPendingIntent3(Context context, int appWidgetId) {
		    ...
		    intent3.setAction("pl.looksok.intent.action.bCHANGE_PICTURE3X");
		...
		public static PendingIntent buildButtonPendingIntent4(Context context, int appWidgetId) {
		    ...
		    intent4.setAction("pl.looksok.intent.action.bCHANGE_PICTURE4X");
		...
		public static PendingIntent activityPending(Context context, int appWidgetId) {
		    ...
		    intent5.setAction("pl.looksok.intent.action.bNEW_ACTIVITYX");
